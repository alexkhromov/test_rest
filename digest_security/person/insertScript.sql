...
begin
  ...
  EXECUTE IMMEDIATE 'INSERT INTO USERS ( USERNAME, USERPASSWORD ) VALUES ( ''digest'', ''23efb615841d88ea30358442f3a9b10f'' )';

  EXECUTE IMMEDIATE 'INSERT INTO ROLE ( ROLENAME) VALUES ( ''restful'' )';
  EXECUTE IMMEDIATE 'INSERT INTO ROLE ( ROLENAME) VALUES ( ''restcust'' )';
  EXECUTE IMMEDIATE 'INSERT INTO ROLE ( ROLENAME) VALUES ( ''digestdb'' )';
  ...
  EXECUTE IMMEDIATE 'INSERT INTO USERROLE ( USERNAME, ROLENAME ) VALUES ( ''digest'', ''digestdb'' )';
end;
/